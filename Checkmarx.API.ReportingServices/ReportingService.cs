...
namespace Checkmarx.API.ReportingServices
{
    ...
    public partial class ReportingService
    {
        ...
        public ReportingService(string baseUrl, System.Net.Http.HttpClient httpClient)
        {
            BaseUrl = baseUrl;
        ...
        /// <summary>
        /// Retrieve the file of a specific Report
        /// </summary>
        /// <param name="id">Unique ID of a specific Report</param>
        /// <returns>Returns the report file</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<FileResponse> ReportsGETAsync(long id)
        {
            return ReportsGETAsync(id, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Returns the report file</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<FileResponse> ReportsGETAsync(long id, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 404)
                        {
                            ...
                            throw new ApiException<ErrorDetails>("Requested Report doesn\'t exist", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 401)
                        {
                        ...
                        {
                            string responseText_ = (response_.Content == null) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("Forbidden access", status_, responseText_, headers_, null);
                        }
                        else
                        {
        ...
        /// </summary>
        /// <returns>Successfull call: returns the newly created Report ID</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<CreateReportResponseDTO> CreateReportAsync(CreateReportDTO body)
        {
        ...
        /// <returns>Successfull call: returns the newly created Report ID</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<CreateReportResponseDTO> CreateReportAsync(CreateReportDTO body, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 400)
                        {
                            ...
                            throw new ApiException<ErrorDetails>("Invalid Post Body", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 401)
                        {
        ...
        /// <summary>
        /// Retrieve the status of a specific Report
        /// </summary>
        /// <returns>Returns the Report status</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ReportStatusDTO> ReportStatusAsync(long id)
        {
            return ReportStatusAsync(id, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Returns the Report status</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ReportStatusDTO> ReportStatusAsync(long id, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                throw new System.ArgumentNullException("id");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/reports/{id}/status");
            urlBuilder_.Replace("{id}", System.Uri.EscapeDataString(ConvertToString(id, System.Globalization.CultureInfo.InvariantCulture)));
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ReportStatusDTO>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
                        ...
                        if (status_ == 404)
                        {
                            ...
                            throw new ApiException<ErrorDetails>("Requested Report requested doesn\'t exist", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 401)
                        {
    ...
    public partial class CreateReportDTO
    {
        ...
        public System.Collections.Generic.ICollection<string> EntityId { get; set; }
    ...
    public partial class FilterDTO
    {
        ...
        [Newtonsoft.Json.JsonProperty("excludedValues", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<string> ExcludedValues { get; set; }
